/**
 * @dsh-external/dsh-github-push — 工具包形态（由 dev_scaffold_plugin 生成）。
...
export function apply(ctx: Context, config: Config): void {
  ...
  ctx.effect(() => ctx.tools.register(defineTool({
    name: '_dsh_external_dsh_github_push_hello',
    description: "One-step GitHub uploader: given a repo URL, init/commit/push the current project to GitHub.",
    parameters: {
  ...
  })), '@dsh-external/dsh-github-push: hello tool')
  ...
  //   const MINE = new Set(['_dsh_external_dsh_github_push_hello'])
  //   const CORE = '<核心工具>'
