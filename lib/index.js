...
export function apply(ctx, config) {
  ctx.effect(() => ctx.tools.register(defineTool({
    ...
    description: 'One-step upload a local project to GitHub: given a repo URL, auto-create/improve README, initialize git if needed, add/commit all files, set the GitHub remote, and push. Optionally creates the repo via gh CLI when it does not exist yet.',
    parameters: {
